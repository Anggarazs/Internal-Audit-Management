                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('departement') is-invalid @enderror" name="departement" id="departement"
                                          placeholder="Departement" required value="{{ old('departement') }}">
                                        @error('departement')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
