...
<head>
    ...
    <!-- ICONS -->
	<link rel="icon" type="image/png" sizes="96x96" href="https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Adidas_Logo.svg/1200px-Adidas_Logo.svg.png">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">Audit Management</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Event Report</a>
                        <a class="collapse-item" href="cards.html">View Audit</a>
                        <a class="collapse-item" href="cards.html">PICA Audit</a>
                    </div>
                </div>
            </li>
